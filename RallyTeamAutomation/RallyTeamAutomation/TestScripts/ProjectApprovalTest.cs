    ...
    public class ProjectApprovalTest : BaseTestES
    {
        ...
        public void setProjectApproval()
        {
           // commonPage.ScrollDown();
            ...
            commonIssuePage.setProjectApproval();     
        ...
        public void ProjectApproval_002_VerifyProjectAboutPageOptionForAdmin()
        {
            ...
            Thread.Sleep(2000);
            postProjectPage.VerifyApproveButtonOnAboutPage();
            log.Info("Verify Approve button");

            //Verify Deny Button            
            Thread.Sleep(2000);
            postProjectPage.VerifyDenyButtonOnAboutPage();
            log.Info("Verify Deny Button");
        ...
        public void ProjectApproval_003_VerifyProjectApproveByAdmin()
        {
            ...
            //Verify Deny Button            
            Thread.Sleep(2000);
            postProjectPage.clickApproveButtonOnAboutPage();
        ...
        public void ProjectApproval_004_VerifyProjectDenyByAdmin()
        {
            ...
            //Verify Deny Button            
            Thread.Sleep(2000);
            postProjectPage.ClickDenyButtonOnAboutPage();
            log.Info("Click Deny Button");
